# https://github.com/huggingface/transformers/blob/04ab5605fbb4ef207b10bf2772d88c53fc242e83/examples/pytorch/image-classification/run_image_classification_no_trainer.py
# coding=utf-8
...
def main():
    ...
    # for microsoft/resnet-50
    # import torch.nn as nn
    # model.classifier[1] = nn.Linear(2048, 29)
...
if __name__ == "__main__":
    main()
    # python run_image_classification_no_trainer.py --train_dir CRC02 --output_dir model_CRC02_10epochs --per_device_train_batch_size 32 --per_device_eval_batch_size 32 --num_train_epochs 10